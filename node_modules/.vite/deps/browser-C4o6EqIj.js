...
var Engine = class {
	...
	async load(params) {
		...
		const { Container } = await import("./Container-GEYgX1YO.js"), id = params.id ?? domSourceElement?.id ?? `tsparticles${Math.floor(getRandom() * 1e4).toString()}`, { index, url } = params, currentOptions = itemFromSingleOrMultiple(url ? await getDataFromUrl({
...
//# sourceMappingURL=browser-C4o6EqIj.js.map
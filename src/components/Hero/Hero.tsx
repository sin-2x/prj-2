...
const scenes: Scene[] = [
  ...
  },
  {
    ...
    lines: [
      ...
      "Мүмкін, бұл — сені шын жақсы көрген адамның күйі шығар.",
      "Мүмкін, бұл шынайы сезім шығар...",
      "Өйткені адам біреуді өз қалауымен жақсы көріп қалмайды.",
      "Сезім өздігінен келеді.",
      "Ал шын сүйген адам оны тоқтата да, ұмыта да алмайды.",
      "Өйткені...",
